...
#import "CircleChatViewController.h"

@interface CircleChatViewController ()
...
@implementation CircleChatViewController
...
- (void)setupTestModel
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://www.gravatar.com/avatar/67675a7b446daa745a276d59d5f936ba?s=128&d=identicon&r=PG"];
    NSData *data = [NSData dataWithContentsOfURL:url];
    UIImage *img = [[UIImage alloc] initWithData:data];
    
    UIImage *cookImage = [JSQMessagesAvatarFactory avatarWithImage:img
                                                          diameter:incomingDiameter];
    
    UIImage *jobsImage = [JSQMessagesAvatarFactory avatarWithImage:img
                                                          diameter:incomingDiameter];
    
    UIImage *wozImage = [JSQMessagesAvatarFactory avatarWithImage:img
                                                         diameter:incomingDiameter];
...
- (void)receiveMessagePressed:(UIBarButtonItem *)sender
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
         ...
         */
        copyMessage.sender = self.sender;
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    /*
     TODO: If you want to add image to chat.
    NSURL *url = [NSURL URLWithString:@"https://www.gravatar.com/avatar/67675a7b446daa745a276d59d5f936ba?s=128&d=identicon&r=PG"];
    NSData *data = [NSData dataWithContentsOfURL:url];
    UIImage *img = [[UIImage alloc] initWithData:data];
    
    UIImageView *imageView = [[UIImageView alloc] initWithImage:img];
    [imageView setFrame:cell.textView.frame];
